  ...
  const jalaliDate = format(parseISO(gregorianDate), 'yyyy/MM/dd');
    ...
    const timer = setTimeout(() => {
      setDate((prevData)=>({
        ...prevData,
        date:jalaliDate 
      })) // تغییر وضعیت به ناپدید شدن بعد از ۳ ثانیه
...
<></>
  ...
  return (
    <header dir="rtl" className="no-print sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
