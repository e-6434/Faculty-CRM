...
import { CheckUserEmail } from '@/action/auth-action';
  ...
  return (
      ...
      <div  className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center ">
          <div dir="rtl" className="hidden w-full xl:block xl:w-1/2">
            <div dir="rtl" className="px-26 py-17.5 text-center">
 

              <p className="2xl:px-20">
  سامانه <span className="text-red text-title-sm"> توانـــا</span> سامانه ای  با رویکرد مدیریت محور ،در راستای شکوفایی دانشگاه تمدن ساز <span className="text-red text-title-sm"> شهید </span> ستاری
              </p>
          ...
          <div dir="rtl" className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                ...
                <div  className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      name="password"
                      placeholder="گذروازه خودرا وارد نمایید"
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
