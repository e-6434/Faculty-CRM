...
import { CreateLessonGroup, SearchLesson_For_Insert_LessonGroup, SearchTeacher_For_Insert_LessonGroup, UpdatLessonGroup } from "@/action/lesson_group";
...
const NewGroupLessonForm_For_Updat = ({data}:any) => {
  ...
  const [revalidat,setRevalidat] = useState(false);
  const [image, setImage] = useState<File | null>(null);
  const [image2, setImage2] = useState('');
  const [lessonDetail,setLessonDetail ] = useState<LessonData[]>([]);
  const [formData,setFormFata] = useState<LessonGroupData> ({lessonName:'' , teacher:'' ,hour:'' ,year:'' ,term:'' ,class:'' ,grupID:null, day:''});
  const [formData2,setFormFata2] = useState<LessonGroupData> ({lessonName:'' , teacher:'' ,hour:'' ,year:'' ,term:'' ,class:'' ,grupID:null, day:''});
 ...
 useEffect(() => {
  const fetchData = async () => {
      try {
       ...
       setFormFata2((prevData)=>({
        ...prevData,
        teacher:Teacher.filter( (e:any)=> e.id === parseInt(data?.teacher_id))[0]?.id +'-'+Teacher.filter( (e:any)=> e.id === parseInt(data?.teacher_id))[0]?.name+'-'+Teacher.filter( (e:any)=> e.id === parseInt(data?.teacher_id))[0]?.family,
      }))
      setFormFata2((prevData)=>({
        ...prevData,
        lessonName:  Lesson.filter( (e:any)=> e.id === parseInt(data?.lesson_id))[0]?.id+'-'+Lesson.filter( (e:any)=> e.id === parseInt(data?.lesson_id))[0]?.name

      }))
      setFormFata2((prevData)=>({
        ...prevData,
        class: data?.group_id.charAt(6),
        term:  data?.group_id.charAt(4),
        day: Day_c( data?.group_id.charAt(5)),
        hour:Hour_c( data?.group_id.charAt(7)),
        year: data?.group_id.slice(0,4),
      }))
      ...
      setFormFata ((prevData)=>({
        ...
        class: data?.group_id.charAt(6),
        term:  data?.group_id.charAt(4),
        day:   data?.group_id.charAt(5) ,
        hour:  data?.group_id.charAt(7) ,
        year:  data?.group_id.slice(0,4),
      }))
  ...
  const addSubmit= async( )=>{
    ...
    const result =  await UpdatLessonGroup(formData as any, data as any)
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row  ">
                   ...
                   <MenuBookOutlinedIcon/>   نام درس
                    ...
                    <select onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                       <option   className="bg-lime-200" > {formData.lessonName}</option>
                  ...
                  <div className="w-full xl:w-1/2">
                    ...
                    <select onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                        <option    className="bg-lime-200" > {formData.teacher}</option>
              ...
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                 <div className="w-full xl:w-1/2">
                  ...
                  onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                        <option   className="bg-lime-200">{ Day_c(formData.day)} </option>
                 ...
                 <div className="w-full xl:w-1/2">
                  ...
                  onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                      <option   className="bg-lime-200" > { Hour_c(formData.hour) } </option>
                 ...
                 <div className="w-full xl:w-1/2">
                    ...
                    onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                       <option   className="bg-lime-200" > { formData.year} </option>
                ...
                <ClassIcon/>   کلاس 
                    ...
                    onChange={handlChange} 
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                         <option   className="bg-lime-200"> کلاس{formData.class}</option>
                  ...
                  <CastForEducationIcon/>  ترم  
                     ...
                     className="bg-slate-200 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                       >
                        <option   className="bg-lime-200"  > {Term_c(formData.term)} </option>
...
<div dir="rtl" className="fixed    inset-115   bg-opacity-70 flex justify-start items-center z-50 top-0 right-10"  >
            ...
            <div className="flex top-9 right-9      bg-green-100 w-full h-18 border-l-6 border-[#34D399]     shadow-md   dark:bg-[#1B1B24] dark:bg-opacity-30 py-1 ">
                                ...
                                <div className="w-full"> 
                                  <h5 className="mb-3 text-sm font-semibold text-black dark:text-[#34D399] ">
                                      گروه درسی با موفقیت به روزرسانی گردید    
                                  </h5>
                                  <p className="text-xm leading-relaxed text-body">
                                  شماره گروه  : {formData.grupID}
                                  </p>
                                </div>
...
export default NewGroupLessonForm_For_Updat;
