...
import { AllSearchLessonGroup, SearchLessonGroupByTeacher, SearchLessonGroupByTerm   } from "@/action/lesson_group";
 import '@/components/allweekforTeacher/css.css'
...
const AllweekforTeacher = () => {
  ...
  const [formData,setFormData] = useState<Search>({  teacherid:'',term:'' , year:jalaliDate.slice(0,4)});
 

  useEffect(() => {
    const fetchData5 = async () => {
        
         const GroupData = await  SearchLessonGroupByTeacher(formData as any);
...
export default AllweekforTeacher;
